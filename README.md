<!-- Dynamic typing header — paste this at the very top -->
[![Typing SVG](https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=22&pause=1000&color=00C9A7&width=600&lines=Building+systems+that+matter.;Full-Stack+%7C+Backend+%7C+Mobile+%7C+AI;Nairobi+%E2%86%92+The+World.)](https://git.io/typing-svg)
...
in under-resourced schools, and in the daily friction of life in Nairobi.  
That context shapes everything I build.

Currently studying **Computing and Information Systems** while shipping real products.
...
and Flutter for mobile. I think in systems. I build for real users.  
And I'm drawn to problems where the software has to actually work — no luxury  
of perfect infrastructure, reliable power, or fast internet. That constraint  
makes for better engineers.

I'm early. But I'm moving with intent.
...
The goal is not just to become a strong engineer.  
The goal is to build things that outlast the version of me that made them.
...
# 📊 GitHub Stats:
![](https://github-readme-stats.shion.dev/api?username=builtbyACE&theme=dark&hide_border=false&include_all_commits=false&count_private=false)<br/>
